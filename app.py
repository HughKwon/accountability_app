...
from resources.usertask import blp as UserTaskBlueprint
...
def create_app(db_url=None):
    ...
    app.config["JWT_SECRET_KEY"] = "Hugh"
    ...
    # No longer need to tell Flask-SQLAlchemy to create the DB, since we're using Flask-Migrate
